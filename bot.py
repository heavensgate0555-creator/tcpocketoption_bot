...
TOKEN = "8588513246:AAGaQWZX5xU8hJMwETxyYfYCkWlJ2zzIJho"   # 🔥 PUT YOUR REAL TOKEN HERE
ADMIN_ID = 8333660216               # 🔥 YOUR TELEGRAM ID
...
def main():
    ...
    app.add_handler(CommandHandler("begin", start))  # 🔥 NEW COMMAND
